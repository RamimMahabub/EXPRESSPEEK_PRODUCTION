...
'zone' => $zone
    ...
    {
        $homeDirectory = dirname(base_path());
        $cpanelPythonBinaries = array_merge(
            glob($homeDirectory . '/virtualenv/python_app/*/bin/python') ?: [],
            glob($homeDirectory . '/virtualenv/python_runtime/*/bin/python') ?: []
        );

        $candidates = array_values(array_unique(array_filter([
            env('PYTHON_BINARY'),
            ...$cpanelPythonBinaries,
            '/usr/bin/python3',
            'python3',
            'python',
            'py',
