    ...
    <div class="xl:col-span-2">
        <div class="neon-card rounded-2xl p-6 sticky top-6">
            <div class="flex items-center justify-between mb-5">
                ...
                <a href="{{ route('customer.shipments.create') }}" class="text-xs text-violet-400 hover:text-violet-300 transition-colors">Create shipment →</a>
            </div>
...
function loadAddressBookEntries() {
    ...
    fetch('{{ route("customer.address-book.api.index", [], false) }}', {
...
function deleteAddressEntry(id) {
    ...
    fetch(`/customer/api/address-book/${id}`, {
        method: 'DELETE',
        credentials: 'same-origin',
        headers: {
