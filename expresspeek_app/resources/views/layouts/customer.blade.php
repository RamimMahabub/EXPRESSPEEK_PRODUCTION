...
<head>
    ...
    <meta name="description" content="ExpressPeek — Fast, reliable international logistics and courier services.">

    <title>ExpressPeek — @yield('title', 'Logistics & Shipping')</title>
