<header class="flex items-center justify-between px-6 py-4 bg-gray-900/80 backdrop-blur border-b border-white/10 flex-shrink-0">

    {{-- Page Title --}}
    <div>
        <h1 class="text-lg font-semibold text-white">@yield('page-title', 'Dashboard')</h1>
        <p class="text-xs text-slate-400">@yield('page-subtitle', config('app.name'))</p>
    </div>
    ...
    <div class="flex items-center gap-4">
        ...
        <button class="relative p-2 rounded-lg text-slate-400 hover:text-white hover:bg-gray-800 transition-colors">
